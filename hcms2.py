...
#             # cv2.putText(FR, "Warning", (400, H+60),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0,255), 2)
#             cv2.putText(FR,"Warning!!",(400, H+60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
#             # cv2.rectangle(FR, (10, H+80), (760, H+140+40), (100, 100, 100), 2)

#             risk = total_p
#             tot_str = "TOTAL COUNT: " + str(total_p)
#             high_str = "HIGH RISK COUNT: " + str(high_risk_p)
#             main_count = high_risk_p
...
#             cv2.putText(FR, tot_str, (50, H +25),
#                         cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 2)
#             cv2.putText(FR, safe_str, (400, H +25),
...
#     if(risk >= 30 and main_count >= risk/2):
#                 cv2.putText(FR,"Warning!!",(400, H+60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
